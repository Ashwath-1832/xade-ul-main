    ...
    <section class="container">
      <div class="left-half" style={{}}>
        <div className='line2'>
          ...
          <h3 style={{ fontSize: '32px', lineHeight: '1.2' }}>GLOBAL GASLESS PAYMENTS TO ANY IDENTITY</h3>
          </div>
    ...
    <section class="container" id='container2' >
        ...
        <div class="right-half" >
          <div className="line2" style={{ textAlign: 'left'}}>
            ...
            <div style={{ fontSize: '2rem', fontWeight: 500, lineHeight: 1.2, fontFamily: 'Benzin-Bold' }}>
         <h3 style={{ fontSize: '32px', lineHeight: '1.2' }}>BEAT INFLATION WITH A STABLE SAVINGS ACCOUNT</h3>
            </div>
            <div style={{ fontSize: '1rem', fontFamily: 'Regular' }}>
        ...
        <div class="left-half" style={{}}>
          <div className="line2" style={{}}>
            ...
            <div style={{ fontSize: '2rem', fontWeight: 500, lineHeight: 1.2, fontFamily: 'Benzin-Bold' }}>
             <h3 style={{ fontSize: '32px', lineHeight: '1.2'}}>TRADE ANYTHING WITH 10X LEVERAGE</h3>
            </div>
            <div style={{ fontSize: '1rem', fontFamily: 'Regular' }}>
        ...
        <div class="right-half" >
          <div className="line2" style={{ textAlign: 'left' }}>
            ...
            <div style={{ fontSize: '2rem', fontWeight: 500, lineHeight: 1.2, fontFamily: 'Benzin-Bold' }}>
             <h3 style={{ fontSize: '32px', lineHeight: '1.2'}}>FINANCE YOUR LOANS EASILY AND INSTANTLY</h3>
            </div>
            <div style={{ fontSize: '1rem', fontFamily: 'Regular' }}>
