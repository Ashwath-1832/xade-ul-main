...
export default function FAQ() {
  return (
    <>
      <div id="FAQ-Section" className="faqs">
        ...
        <div className="faqbox">
          ...
          <div className="faqcontent"><span>
            ...
            financial services in a sustainable manner.</span>
          </div>
        </div>
        <div className="faqbox">
     ...
     <span> It's time to unleash a new era of finance with Xade where we provide the only alternative to traditional banks powered by innovative and advanced DeFi protocols</span>
      </div>
