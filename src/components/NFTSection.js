  ...
  return (
    <div className="lol" style = {{backgroundColor: 'rgb(16,16,17)'}}>
      ...
      <div className="header">
        <h2>Feel the premium experience</h2>
      </div>
      <br />
      <div className="topText" style={{fontSize: '1.4rem', marginBottom: '2rem'}}>
      <span>Offering you our unique NFT-based subscriptions that give their owners reduced fees, Xade Tokens, exclusive collectibles, a free card and much more </span></div>
      <br></br>
